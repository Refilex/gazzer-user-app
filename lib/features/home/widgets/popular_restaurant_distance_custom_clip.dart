...
class RestaurantDistanceCustomClip extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint0Stroke.shader = ui.Gradient.linear(
        Offset(size.width * 0.4960317, size.height * -8.802609e-8),
        Offset(size.width * 0.5000000, size.height * 1.086957),
        [const Color(0xffD7D7D7).withOpacity(1), Colors.white.withOpacity(0)],
        [0, 1]);
